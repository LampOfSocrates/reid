...
set -e
# Usage:
#   bash train_mobilenet_v3_small.sh [LR] [MAX_EPOCH] [DATA_FRAC]
#   bash train_mobilenet_v3_small.sh --resume <checkpoint_path> [extra_epochs]
...
SAVE_DIR="logs/$(date +%d%m_%H%M)/train_mobilenet_v3_small_lr${LR}_ep${MAX_EPOCH}_frac${DATA_FRAC}"
