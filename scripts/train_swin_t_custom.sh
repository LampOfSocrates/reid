...
set -e
# Usage:
#   bash train_swin_t_custom.sh [LR] [MAX_EPOCH] [DATA_FRAC]
#   bash train_swin_t_custom.sh --resume <checkpoint_path> [extra_epochs]
...
SAVE_DIR="logs/$(date +%d%m_%H%M)/train_swin_t_custom_lr${LR}_ep${MAX_EPOCH}_frac${DATA_FRAC}"
