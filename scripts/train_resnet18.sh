...
set -e
# Usage:
#   bash train_resnet18.sh [LR] [MAX_EPOCH] [DATA_FRAC]
#   bash train_resnet18.sh --resume <checkpoint_path> [extra_epochs]
...
SAVE_DIR="logs/$(date +%d%m_%H%M)/train_resnet18_lr${LR}_ep${MAX_EPOCH}_frac${DATA_FRAC}"
