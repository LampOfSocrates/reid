...
set -e
# Usage:
#   bash train_clip_senet_v1_dual.sh [LR] [MAX_EPOCH] [DATA_FRAC]
#   bash train_clip_senet_v1_dual.sh --resume <checkpoint_path> [extra_epochs]
...
SAVE_DIR="logs/$(date +%d%m_%H%M)/train_clip_senet_v1_dual_lr${LR}_ep${MAX_EPOCH}_frac${DATA_FRAC}"
