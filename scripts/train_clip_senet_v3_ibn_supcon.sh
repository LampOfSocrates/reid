...
set -e
# Usage:
#   bash train_clip_senet_v3_ibn_supcon.sh [LR] [MAX_EPOCH] [DATA_FRAC]
#   bash train_clip_senet_v3_ibn_supcon.sh --resume <checkpoint_path> [extra_epochs]
...
SAVE_DIR="logs/$(date +%d%m_%H%M)/train_clip_senet_v3_ibn_supcon_lr${LR}_ep${MAX_EPOCH}_frac${DATA_FRAC}"
